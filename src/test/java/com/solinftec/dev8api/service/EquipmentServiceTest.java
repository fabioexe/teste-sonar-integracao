...
class EquipmentServiceTest {
    ...
    void replaceEquipmentWithoutColorWhenUnsuccessful() {
        ...
        Assertions.assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() -> this.equipmentService.replace(this.equipmentPutRequestBodyFactoryUtil.createEquipmentWithoutColor()));
    }
    ...
    void replaceEquipmentWithColorNameInvalidWhenUnsuccessful() {
        ...
        Assertions.assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() -> this.equipmentService.replace(this.equipmentPutRequestBodyFactoryUtil.createEquipmentWithColorNameInvalid()));
    }
