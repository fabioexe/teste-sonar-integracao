...
import com.solinftec.dev8api.util.ApiUserDTOFactoryUtil;
...
class ApiUserResourceTest {
    ...
    private ApiUserDTOFactoryUtil apiUserDTOFactoryUtil;
    ...
    void init() {
        ...
        this.apiUserDTOFactoryUtil = new ApiUserDTOFactoryUtil();
        ...
        BDDMockito.when(this.apiUserService.replace(ArgumentMatchers.any(ApiUserPutRequestBody.class)))
        .thenReturn(apiUserDTOFactoryUtil.createUserDTOSaved());
    }
