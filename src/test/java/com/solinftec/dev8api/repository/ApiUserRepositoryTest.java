...
class ApiUserRepositoryTest {
    ...
    @Test
    void saveOrReplaceUserWithUsernameIsEmptyWhenUnsuccessful() {
    ...
    @Test
    void saveOrReplaceUserWithPasswordIsEmptyWhenUnsuccessful() {
        ApiUser apiUserToBeSaved;
    ...
    @Test
    void saveOrReplaceUserWithEmailIsEmptyWhenUnsuccessful() {
        ApiUser apiUserToBeSaved;
    ...
    @Test
    void saveOrReplaceUsersWithSameUsernamesAndEmailsWhenUnsuccessful() {
        ApiUser firstApiUserToBeSaved, secondApiUserToBeSaved;
        firstApiUserToBeSaved = apiUserFactoryUtil.createUserToBeSaved();
